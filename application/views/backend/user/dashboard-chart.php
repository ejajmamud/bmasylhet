         ...
         if (0 < o("#task-area-chart").length) {
             t.push(this.respChart(o("#task-area-chart"), "Line", {
                 ...
                 datasets: [{
                     ...
                     backgroundColor: "<?php echo get_portal_theme() === 'govt_green' ? 'rgba(0, 166, 62, 0.18)' : 'rgba(49, 95, 166, 0.18)'; ?>",
                     borderColor: "<?php echo get_portal_theme() === 'govt_green' ? '#00a63e' : '#315fa6'; ?>",
                     data: [
         ...
         if (0 < o("#project-status-chart").length) {
             t.push(this.respChart(o("#project-status-chart"), "Doughnut", {
                 ...
                 datasets: [{
                     ...
                     backgroundColor: ["<?php echo get_portal_theme() === 'govt_green' ? '#00a63e' : '#315fa6'; ?>", "#f4be3f"],
